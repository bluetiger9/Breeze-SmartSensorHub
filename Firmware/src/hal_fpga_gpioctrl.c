...
void hal_fpga_gpioctrl_set_output(uint8_t io_pad_num, uint8_t io_pad_value)
{
    uint32_t read_val;
    uint32_t write_val;
...
void hal_fpga_gpioctrl_set_input(uint8_t io_pad_num)
{
    uint32_t read_val;
    uint32_t write_val;
...
uint8_t hal_fpga_gpioctrl_get_value(uint8_t io_pad_num)
{
    uint32_t read_val;
